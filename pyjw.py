...
class Application:
    def __init__(self, master):
        ...
        callbacks = {
            ...
            'settings_trial_of_death': handlers.trial_of_death,
            'settings_campaign': handlers.campaign,
            'settings_caves': handlers.caves,
            'settings_chests': handlers.chests,
            'settings_coliseum': handlers.coliseum,
            'settings_daily_rewards': handlers.daily_rewards,
            'settings_events': handlers.coliseum,
            'settings_all_missions': handlers.missions_all,
            'settings_mailbox': handlers.mailbox,
            'settings_tournament': handlers.tournament,
            'settings_missions': handlers.missions,
            'settings_portal': handlers.portal,
            'settings_trials': handlers.trials,
            'settings_otherworld': handlers.otherworld,
            'settings_otherworld_bash': handlers.otherworld_bash,
            'settings_clan_castle': handlers.clan_castle,
            'settings_treasury': handlers.treasury,
            'settings_clan_store': handlers.clan_store,
            'settings_praises': handlers.praises,
            'settings_caravan': handlers.caravan,
            'settings_altar': handlers.altar,
            'settings_brawls': handlers.brawls,
            'settings_wheel': handlers.wheel,
            'settings_raids': handlers.raids,
            'settings_skill_points': handlers.skill_points,
            'settings_leveling': handlers.leveling,
            'settings_elevating': handlers.elevating,
            'settings_equipping': handlers.equipping,
            'settings_friends': handlers.friends,
